  ...
  return (
    <S.Overlay>
      <S.ModalContainer>
        <S.Header>
          <S.IconContainer>
            <S.KeyIcon src="/key-icon.png" alt="공개 설정" />
          </S.IconContainer>
          <S.TitleSection>
            <S.Title>당신의 시를 공유하시겠습니까?</S.Title>
            <S.Subtitle>다른 탐험가와 감상을 나누거나 개인적으로 간직하세요</S.Subtitle>
          </S.TitleSection>
        </S.Header>
          ...
          >
            <S.OptionHeader>
              <S.OptionIconContainer selected={selectedOption === "public"}>
                <S.OptionIcon src="/public-icon.png" alt="공유서재" />
              </S.OptionIconContainer>
              <S.OptionTextSection>
                <S.OptionTitle>공유서재</S.OptionTitle>
                <S.OptionSubtitle>다른 독자들과 감상을 공유합니다</S.OptionSubtitle>
              </S.OptionTextSection>
            </S.OptionHeader>
            <S.BenefitsList>
              ...
              <S.BenefitItem selected={selectedOption === "public"}>
                <S.Dot selected={selectedOption === "public"} />
                <S.BenefitText>당신의 시적 감상이 다른 이에게 영감을</S.BenefitText>
              </S.BenefitItem>
              <S.BenefitItem selected={selectedOption === "public"}>
                <S.Dot selected={selectedOption === "public"} />
          ...
          >
            <S.OptionHeader>
              <S.OptionIconContainer selected={selectedOption === "private"}>
                <S.OptionIcon src="/private-icon.png" alt="비밀서재" />
              </S.OptionIconContainer>
              <S.OptionTextSection>
                <S.OptionTitle>비밀서재</S.OptionTitle>
                <S.OptionSubtitle>오직 나만을 위한 개인적인 기록</S.OptionSubtitle>
              </S.OptionTextSection>
            </S.OptionHeader>
            <S.BenefitsList>
